...
export const withNotFinishedDealParam =
    (req: RequestWithDeal, res: Response, next: NextFunction) =>
      withRequestParam<Deal>('dealId', 'deal', DealController, BaseController.errorResponse)(req, res, () => {
        try {
...
export default withRequestParam<Deal>('dealId', 'deal', DealController, BaseController.errorResponse)
